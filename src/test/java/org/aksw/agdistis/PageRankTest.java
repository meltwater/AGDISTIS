...
public class PageRankTest {
  ...
  public void oneGetsMost() throws IOException {
    ...
    final Node m = new Node("Master", 0, 0, Algorithm.PAGERANK);
    final Node s1 = new Node("Slave1", 0, 0, Algorithm.PAGERANK);
    final Node s2 = new Node("Slave2", 0, 0, Algorithm.PAGERANK);
    final Node s3 = new Node("Slave3", 0, 0, Algorithm.PAGERANK);
    final Node s4 = new Node("Slave4", 0, 0, Algorithm.PAGERANK);
  ...
  public void soEqual() throws IOException {
    ...
    final Node n1 = new Node("N1", 0, 0, Algorithm.PAGERANK);
    final Node n2 = new Node("N2", 0, 0, Algorithm.PAGERANK);
    final Node n3 = new Node("N3", 0, 0, Algorithm.PAGERANK);
    final Node n4 = new Node("N4", 0, 0, Algorithm.PAGERANK);
