...
public class HitsTest {
  ...
  public void testSimpleHITS() throws InterruptedException, IOException {
    final Graph g = new DirectedSparseMultigraph<Node, String>();
    final Node a = new Node("dbpedia:Barack_Obama,_Sr.", 0, 0, Algorithm.HITS);
    final Node b = new Node("dbpedia:Barack_Obama", 0, 0, Algorithm.HITS);
    final Node c = new Node("dbpedia:Washington,_D.C.", 0, 0, Algorithm.HITS);
    final Node d = new Node("dbpedia:Washington,_D.C._(novel)", 0, 0, Algorithm.HITS);

    final Node e1 = new Node("dbpedia:Ann_Dunham", 0, 1, Algorithm.HITS);
    final Node e2 = new Node("dbpedia:University_of_Hawaii", 0, 1, Algorithm.HITS);
    final Node e3 = new Node("dbpedia:Hawaii", 0, 1, Algorithm.HITS);
    final Node e4 = new Node("dbpedia:White_House", 0, 1, Algorithm.HITS);
    final Node e5 = new Node("dbpedia:Federal_district", 0, 1, Algorithm.HITS);
    final Node e6 = new Node("dbpedia:Elizabeth_II", 0, 1, Algorithm.HITS);
    final Node e7 = new Node("dbpedia:London", 0, 1, Algorithm.HITS);
    final Node e8 = new Node("dbpedia:New_York", 0, 1, Algorithm.HITS);
    final Node e9 = new Node("dbpedia:United_Kingdom", 0, 1, Algorithm.HITS);
    final Node e10 = new Node("dbpedia:Gore_Vidal", 0, 1, Algorithm.HITS);
