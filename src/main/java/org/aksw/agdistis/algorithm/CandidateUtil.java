...
public class CandidateUtil {
  ...
  private final Cache<String, Boolean> disambiguationCache = CacheBuilder.newBuilder().weakKeys().softValues()
      .maximumSize(50000).build();
  private final Cache<String, List<Triple>> candidateCache = CacheBuilder.newBuilder().weakKeys().softValues()
      .maximumSize(50000).build();
