...
public class Stemming {
  private final Logger log = LoggerFactory.getLogger(Stemming.class);
  ...
  public Stemming() {
    ...
    /*
     * This is a pipeline that takes in a string and returns various analyzed linguistic forms. The String is tokenized
     * via a tokenizer (such as PTBTokenizerAnnotator), and then other sequence model style annotation can be used to
     * add things like lemmas, POS tags, and named entities. These are returned as a list of CoreLabels. Other analysis
     * components build and store parse trees, dependency graphs, etc.
     *
     * This class is designed to apply multiple Annotators to an Annotation. The idea is that you first build up the
     * pipeline by adding Annotators, and then you take the objects you wish to annotate and pass them in and get in
     * return a fully annotated object.
     *
  ...
  public String stemming(final String documentText) {
    ...
    String label = null;
    final LancasterStemmer stem = new LancasterStemmer();
    ...
    log.debug("Stemming pipeline took {} msecs.", System.currentTimeMillis() - start);
    return label;
  ...
  public static void main(final String[] args) throws IOException {
     ...
     * "You were bringing me to life."; Lemmatization slem = new Lemmatization();
     * System.out.println(slem.lemmatize(text));
     */
    // String label = "Northern India";
    String label = "Tibetan";
    final Stemming slem = new Stemming();
