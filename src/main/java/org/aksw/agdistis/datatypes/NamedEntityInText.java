...
public class NamedEntityInText implements Comparable<NamedEntityInText>,
    ...
    private String canonicalName; // it is usally the label String attached to
                                  // an entity.
    // eg: <http://dbpedia.org/resource/Tim_Cook>
    // <http://www.w3.org/2000/01/rdf-schema#label> "Tim Cook"@en .
    ...
    private List<AnchorDocument> anchorDocs;

    public List<AnchorDocument> getAnchorDocs() {
        return anchorDocs;
    }

    public void setAnchorDocs(List<AnchorDocument> anchorDocs) {
    ...
    public NamedEntityInText(final int startPos, final int length,
            final String namedEntityUri, final String type,
    ...
    /**
     * @param disambiguatedtype
     *            the disambiguatedTypes to set
     */
    ...
    /**
     * @param authorityWeight
     *            the authorityWeight to set
     */
